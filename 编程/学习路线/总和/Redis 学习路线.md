...
很多同学第一次接触 [Redis](https://www.mianshiya.com/bank/1791375592078610434) 可能都是因为 “缓存”，也有很多同学误以为 Redis 就是缓存、只能做缓存。

事实上，Redis 是知名的高性能内存 K / V 存储系统，除了缓存之外，Redis 还可以用作配置存储、[消息队列](https://www.codefather.cn/course/1793910027205795841)、解决分布式一致性问题等。正因为 Redis 的高性能、通用性、易用性、功能强大，使得它成为了后端开发中必不可少的中间件。
...
### 5、经典[面试题](https://www.mianshiya.com/)
